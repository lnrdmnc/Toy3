...
public class TypeCheck implements Visitor {
    ...
    public Object visit(InitDoForStep initDoForStep) {
        ...
        // Controlla le dichiarazioni di inizializzazione
        ...
        if (bodyType != Type.NOTYPE) {
            throw new RuntimeException("Do body must have NOTYPE, got: " + bodyType);
        }
        ...
        // Controlla le assegnazioni di step
        if (initDoForStep.getStepExprs() != null) {
            Type stepType = (Type) initDoForStep.getStepExprs().accept(this);
            if (stepType != Type.NOTYPE) {
                throw new RuntimeException("Step assignments must have NOTYPE, got: " + stepType);
            }
        }
