...
/**
 * La classe DoubleNode rappresenta un nodo costante di tipo double
...
public class DoubleNode implements Expr {
    ...
    // Valore costante di tipo double rappresentato da questo nodo
    private Object costant;

    // Tabella dei simboli associata al nodo, utile per la gestione degli scope
    private TabellaDeiSimboli tabellaDeiSimboli;

    // Tipo del nodo, che rappresenta il tipo di dato associato (in questo caso, double)
    private Type type;
     ...
     * Permette di applicare un'operazione definita da un Visitor alla classe DoubleNode.
    ...
    /**
     * Costruttore della classe DoubleNode.
     * Inizializza il valore costante del nodo come double.
     * @param value Valore costante di tipo double
     */
    ...
    /**
     * Restituisce una rappresentazione testuale del nodo DoubleNode.
     * @return Stringa che rappresenta il nodo DoubleNode
     */
    @Override
