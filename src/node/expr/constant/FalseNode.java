...
/**
 * La classe FalseNode rappresenta un nodo costante di tipo booleano con valore false
...
public class FalseNode implements Expr {
    ...
    // Valore costante booleano rappresentato da questo nodo (sempre false)
     ...
     * Permette di applicare un'operazione definita da un Visitor alla classe FalseNode.
    ...
    /**
     * Costruttore della classe FalseNode.
     * Inizializza il valore costante del nodo come false.
     */
    public FalseNode() {
        this.costant = false;
    }
     ...
     * @return Valore costante (sempre false)
     */
    ...
    /**
     * Restituisce una rappresentazione testuale del nodo FalseNode.
     * @return Stringa che rappresenta il nodo FalseNode
     */
    @Override
